...
namespace UsbHid
{
    public class UsbHidDevice : IDisposable
    {
        ...
        public bool SetFeature(byte Page,byte[] Feature)
        {
            byte[] feat = new byte[] { Page, Feature[0], Feature[1]};
            return DeviceCommunication.SetDeviceFeature(feat, ref _deviceInformation);
        }
